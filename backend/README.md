...
## Project Structure
    ...
    ├── tst_srtudioofewfqev_66534  # Django project configurations
...
1. Clone this repo and `cd tst_srtudioofewfqev_66534`
...
2. Clone this repo and `cd tst_srtudioofewfqev_66534`
